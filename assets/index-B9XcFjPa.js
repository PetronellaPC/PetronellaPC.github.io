 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ef;function cm(){return ef||(ef=1,(function(r){function d(C,k){var J=C.length;C.push(k);t:for(;0<J;){var yt=J-1>>>1,bt=C[yt];if(0<f(bt,k))C[yt]=k,C[J]=bt,J=yt;else break t}}function o(C){return C.length===0?null:C[0]}function u(C){if(C.length===0)return null;var k=C[0],J=C.pop();if(J!==k){C[0]=J;t:for(var yt=0,bt=C.length,v=bt>>>1;yt<v;){var L=2*(yt+1)-1,H=C[L],Y=L+1,P=C[Y];if(0>f(H,J))Y<bt&&0>f(P,H)?(C[yt]=P,C[Y]=J,yt=Y):(C[yt]=H,C[L]=J,yt=L);else if(Y<bt&&0>f(P,J))C[yt]=P,C[Y]=J,yt=Y;else break t}}return k}function f(C,k){var J=C.sortIndex-k.sortIndex;return J!==0?J:C.id-k.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;r.unstable_now=function(){return m.now()}}else{var g=Date,E=g.now();r.unstable_now=function(){return g.now()-E}}var b=[],y=[],R=1,w=null,O=3,Z=!1,X=!1,U=!1,j=!1,D=typeof setTimeout=="function"?setTimeout:null,F=typeof clearTimeout=="function"?clearTimeout:null,K=typeof setImmediate<"u"?setImmediate:null;function ht(C){for(var k=o(y);k!==null;){if(k.callback===null)u(y);else if(k.startTime<=C)u(y),k.sortIndex=k.expirationTime,d(b,k);else break;k=o(y)}}function ft(C){if(U=!1,ht(C),!X)if(o(b)!==null)X=!0,At||(At=!0,Qt());else{var k=o(y);k!==null&&Wt(ft,k.startTime-C)}}var At=!1,$=-1,zt=5,Vt=-1;function We(){return j?!0:!(r.unstable_now()-Vt<zt)}function he(){if(j=!1,At){var C=r.unstable_now();Vt=C;var k=!0;try{t:{X=!1,U&&(U=!1,F($),$=-1),Z=!0;var J=O;try{e:{for(ht(C),w=o(b);w!==null&&!(w.expirationTime>C&&We());){var yt=w.callback;if(typeof yt=="function"){w.callback=null,O=w.priorityLevel;var bt=yt(w.expirationTime<=C);if(C=r.unstable_now(),typeof bt=="function"){w.callback=bt,ht(C),k=!0;break e}w===o(b)&&u(b),ht(C)}else u(b);w=o(b)}if(w!==null)k=!0;else{var v=o(y);v!==null&&Wt(ft,v.startTime-C),k=!1}}break t}finally{w=null,O=J,Z=!1}k=void 0}}finally{k?Qt():At=!1}}}var Qt;if(typeof K=="function")Qt=function(){K(he)};else if(typeof MessageChannel<"u"){var Le=new MessageChannel,ye=Le.port2;Le.port1.onmessage=he,Qt=function(){ye.postMessage(null)}}else Qt=function(){D(he,0)};function Wt(C,k){$=D(function(){C(r.unstable_now())},k)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(C){C.callback=null},r.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):zt=0<C?Math.floor(1e3/C):5},r.unstable_getCurrentPriorityLevel=function(){return O},r.unstable_next=function(C){switch(O){case 1:case 2:case 3:var k=3;break;default:k=O}var J=O;O=k;try{return C()}finally{O=J}},r.unstable_requestPaint=function(){j=!0},r.unstable_runWithPriority=function(C,k){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var J=O;O=C;try{return k()}finally{O=J}},r.unstable_scheduleCallback=function(C,k,J){var yt=r.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?yt+J:yt):J=yt,C){case 1:var bt=-1;break;case 2:bt=250;break;case 5:bt=1073741823;break;case 4:bt=1e4;break;default:bt=5e3}return bt=J+bt,C={id:R++,callback:k,priorityLevel:C,startTime:J,expirationTime:bt,sortIndex:-1},J>yt?(C.sortIndex=J,d(y,C),o(b)===null&&C===o(y)&&(U?(F($),$=-1):U=!0,Wt(ft,J-yt))):(C.sortIndex=bt,d(b,C),X||Z||(X=!0,At||(At=!0,Qt()))),C},r.unstable_shouldYield=We,r.unstable_wrapCallback=function(C){var k=O;return function(){var J=O;O=k;try{return C.apply(this,arguments)}finally{O=J}}}})(Mu)),Mu}var nf;function dm(){return nf||(nf=1,Cu.exports=cm()),Cu.exports}var Bu={exports:{}},I={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sf;function fm(){if(sf)return Kt;sf=1;var r=qu();function d(b){var y="https://react.dev/errors/"+b;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var R=2;R<arguments.length;R++)y+="&args[]="+encodeURIComponent(arguments[R])}return"Minified React error #"+b+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var u={d:{f:o,r:function(){throw Error(d(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},f=Symbol.for("react.portal");function m(b,y,R){var w=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:w==null?null:""+w,children:b,containerInfo:y,implementation:R}}var g=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function E(b,y){if(b==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return Kt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=u,Kt.createPortal=function(b,y){var R=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(d(299));return m(b,y,null,R)},Kt.flushSync=function(b){var y=g.T,R=u.p;try{if(g.T=null,u.p=2,b)return b()}finally{g.T=y,u.p=R,u.d.f()}},Kt.preconnect=function(b,y){typeof b=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,u.d.C(b,y))},Kt.prefetchDNS=function(b){typeof b=="string"&&u.d.D(b)},Kt.preinit=function(b,y){if(typeof b=="string"&&y&&typeof y.as=="string"){var R=y.as,w=E(R,y.crossOrigin),O=typeof y.integrity=="string"?y.integrity:void 0,Z=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;R==="style"?u.d.S(b,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:w,integrity:O,fetchPriority:Z}):R==="script"&&u.d.X(b,{crossOrigin:w,integrity:O,fetchPriority:Z,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},Kt.preinitModule=function(b,y){if(typeof b=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var R=E(y.as,y.crossOrigin);u.d.M(b,{crossOrigin:R,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&u.d.M(b)},Kt.preload=function(b,y){if(typeof b=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var R=y.as,w=E(R,y.crossOrigin);u.d.L(b,R,{crossOrigin:w,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},Kt.preloadModule=function(b,y){if(typeof b=="string")if(y){var R=E(y.as,y.crossOrigin);u.d.m(b,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:R,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else u.d.m(b)},Kt.requestFormReset=function(b){u.d.r(b)},Kt.unstable_batchedUpdates=function(b,y){return b(y)},Kt.useFormState=function(b,y,R){return g.H.useFormState(b,y,R)},Kt.useFormStatus=function(){return g.H.useHostTransitionStatus()},Kt.version="19.2.7",Kt}var rf;function pm(){if(rf)return Wu.exports;rf=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(d){console.error(d)}}return r(),Wu.exports=fm(),Wu.exports}/**
 * @license React
 ...
 *
 * @license MIT
 */var ju=/^(?:[a-z][a-z0-9+.-]*:|[\\/]{2})/i,vf=/^[\\/]{2}/;function vm(r,d){return d+r.replace(/\\/g,"/")}var df="popstate";function of(r){return typeof r=="object"&&r!=null&&"pathname"in r&&"search"in r&&"hash"in r&&"state"in r&&"key"in r}function xm(r={}){function d(u,f){var y;let m=(y=f.state)==null?void 0:y.masked,{pathname:g,search:E,hash:b}=m||u.location;return Du("",{pathname:g,search:E,hash:b},f.state&&f.state.usr||null,f.state&&f.state.key||"default",m?{pathname:u.location.pathname,search:u.location.search,hash:u.location.hash}:void 0)}function o(u,f){return typeof f=="string"?f:Ll(f)}return bm(d,o,null,r)}function wt(r,d){if(r===!1||r===null||typeof r>"u")throw new Error(d)}function Me(r,d){if(!r){typeof console<"u"&&console.warn(d);try{throw new Error(d)}catch{}}}function gm(){return Math.random().toString(36).substring(2,10)}function ff(r,d){return{usr:r.state,key:r.key,idx:d,masked:r.mask?{pathname:r.pathname,search:r.search,hash:r.hash}:void 0}}function Du(r,d,o=null,u,f){return{pathname:typeof r=="string"?r:r.pathname,search:"",hash:"",...typeof d=="string"?La(d):d,state:o,key:d&&d.key||u||gm(),mask:f}}function Ll({pathname:r="/",search:d="",hash:o=""}){return d&&d!=="?"&&(r+=d.charAt(0)==="?"?d:"?"+d),o&&o!=="#"&&(r+=o.charAt(0)==="#"?o:"#"+o),r}function La(r){let d={};if(r){let o=r.indexOf("#");o>=0&&(d.hash=r.substring(o),r=r.substring(0,o));let u=r.indexOf("?");u>=0&&(d.search=r.substring(u),r=r.substring(0,u)),r&&(d.pathname=r)}return d}function bm(r,d,o,u={}){let{window:f=document.defaultView,v5Compat:m=!1}=u,g=f.history,E="POP",b=null,y=R();y==null&&(y=0,g.replaceState({...g.state,idx:y},""));function R(){return(g.state||{idx:null}).idx}function w(){E="POP";let j=R(),D=j==null?null:j-y;y=j,b&&b({action:E,location:U.location,delta:D})}function O(j,D){E="PUSH";let F=of(j)?j:Du(U.location,j,D);y=R()+1;let K=ff(F,y),ht=U.createHref(F.mask||F);try{g.pushState(K,"",ht)}catch(ft){if(ft instanceof DOMException&&ft.name==="DataCloneError")throw ft;f.location.assign(ht)}m&&b&&b({action:E,location:U.location,delta:1})}function Z(j,D){E="REPLACE";let F=of(j)?j:Du(U.location,j,D);y=R();let K=ff(F,y),ht=U.createHref(F.mask||F);g.replaceState(K,"",ht),m&&b&&b({action:E,location:U.location,delta:0})}function X(j){return _m(f,j)}let U={get action(){return E},get location(){return r(f,g)},listen(j){if(b)throw new Error("A history only accepts one active listener");return f.addEventListener(df,w),b=j,()=>{f.removeEventListener(df,w),b=null}},createHref(j){return d(f,j)},createURL:X,encodeLocation(j){let D=X(j);return{pathname:D.pathname,search:D.search,hash:D.hash}},push:O,replace:Z,go(j){return g.go(j)}};return U}function _m(r,d,o=!1){let u="http://localhost";r&&(u=r.location.origin!=="null"?r.location.origin:r.location.href),wt(u,"No window.location.(origin|href) available to create URL");let f=typeof d=="string"?d:Ll(d);return f=f.replace(/ $/,"%20"),!o&&vf.test(f)&&(f=u+f),new URL(f,u)}function xf(r,d,o="/"){return Am(r,d,o,!1)}function Am(r,d,o,u,f){let m=typeof d=="string"?La(d):d,g=ln(m.pathname||"/",o);if(g==null)return null;let E=Sm(r),b=null,y=Lm(g);for(let R=0;b==null&&R<E.length;++R)b=Wm(E[R],y,u);return b}function Sm(r){let d=gf(r);return Em(d),d}function gf(r,d=[],o=[],u="",f=!1){let m=(g,E,b=f,y)=>{let R={relativePath:y===void 0?g.path||"":y,caseSensitive:g.caseSensitive===!0,childrenIndex:E,route:g};if(R.relativePath.startsWith("/")){if(!R.relativePath.startsWith(u)&&b)return;wt(R.relativePath.startsWith(u),`Absolute route path "${R.relativePath}" nested under path "${u}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),R.relativePath=R.relativePath.slice(u.length)}let w=Ce([u,R.relativePath]),O=o.concat(R);g.children&&g.children.length>0&&(wt(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${w}".`),gf(g.children,d,O,w,b)),!(g.path==null&&!g.index)&&d.push({path:w,score:Mm(w,g.index),routesMeta:O.map((Z,X)=>{let[U,j]=Af(Z.relativePath,Z.caseSensitive,X===O.length-1);return{...Z,matcher:U,compiledParams:j}})})};return r.forEach((g,E)=>{var b;if(g.path===""||!((b=g.path)!=null&&b.includes("?")))m(g,E);else for(let y of bf(g.path))m(g,E,!0,y)}),d}function bf(r){let d=r.split("/");if(d.length===0)return[];let[o,...u]=d,f=o.endsWith("?"),m=o.replace(/\?$/,"");if(u.length===0)return f?[m,""]:[m];let g=bf(u.join("/")),E=[];return E.push(...g.map(b=>b===""?m:[m,b].join("/"))),f&&E.push(...g),E.map(b=>r.startsWith("/")&&b===""?"/":b)}function Em(r){r.sort((d,o)=>d.score!==o.score?o.score-d.score:Bm(d.routesMeta.map(u=>u.childrenIndex),o.routesMeta.map(u=>u.childrenIndex)))}var Tm=/^:[\w-]+$/,wm=3,Rm=2,Nm=1,zm=10,Cm=-2,pf=r=>r==="*";function Mm(r,d){let o=r.split("/"),u=o.length;return o.some(pf)&&(u+=Cm),d&&(u+=Rm),o.filter(f=>!pf(f)).reduce((f,m)=>f+(Tm.test(m)?wm:m===""?Nm:zm),u)}function Bm(r,d){return r.length===d.length&&r.slice(0,-1).every((u,f)=>u===d[f])?r[r.length-1]-d[d.length-1]:0}function Wm(r,d,o=!1){let{routesMeta:u}=r,f={},m="/",g=[];for(let E=0;E<u.length;++E){let b=u[E],y=E===u.length-1,R=m==="/"?d:d.slice(m.length)||"/",w={path:b.relativePath,caseSensitive:b.caseSensitive,end:y},O=b.matcher&&b.compiledParams?_f(w,R,b.matcher,b.compiledParams):ls(w,R),Z=b.route;if(!O&&y&&o&&!u[u.length-1].route.index&&(O=ls({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},R)),!O)return null;Object.assign(f,O.params),g.push({params:f,pathname:Ce([m,O.pathname]),pathnameBase:Dm(Ce([m,O.pathnameBase])),route:Z}),O.pathnameBase!=="/"&&(m=Ce([m,O.pathnameBase]))}return g}function ls(r,d){typeof r=="string"&&(r={path:r,caseSensitive:!1,end:!0});let[o,u]=Af(r.path,r.caseSensitive,r.end);return _f(r,d,o,u)}function _f(r,d,o,u){let f=d.match(o);if(!f)return null;let m=f[0],g=m.replace(/(.)\/+$/,"$1"),E=f.slice(1);return{params:u.reduce((y,{paramName:R,isOptional:w},O)=>{if(R==="*"){let X=E[O]||"";g=m.slice(0,m.length-X.length).replace(/(.)\/+$/,"$1")}const Z=E[O];return w&&!Z?y[R]=void 0:y[R]=(Z||"").replace(/%2F/g,"/"),y},{}),pathname:m,pathnameBase:g,pattern:r}}function Af(r,d=!1,o=!0){Me(r==="*"||!r.endsWith("*")||r.endsWith("/*"),`Route path "${r}" will be treated as if it were "${r.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${r.replace(/\*$/,"/*")}".`);let u=[],f="^"+r.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(g,E,b,y,R)=>{if(u.push({paramName:E,isOptional:b!=null}),b){let w=R.charAt(y+g.length);return w&&w!=="/"?"/([^\\/]*)":"(?:/([^\\/]*))?"}return"/([^\\/]+)"}).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return r.endsWith("*")?(u.push({paramName:"*"}),f+=r==="*"||r==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?f+="\\/*$":r!==""&&r!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,d?void 0:"i"),u]}function Lm(r){try{return r.split("/").map(d=>decodeURIComponent(d).replace(/\//g,"%2F")).join("/")}catch(d){return Me(!1,`The URL path "${r}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${d}).`),r}}function ln(r,d){if(d==="/")return r;if(!r.toLowerCase().startsWith(d.toLowerCase()))return null;let o=d.endsWith("/")?d.length-1:d.length,u=r.charAt(o);return u&&u!=="/"?null:r.slice(o)||"/"}function Om(r,d="/"){let{pathname:o,search:u="",hash:f=""}=typeof r=="string"?La(r):r,m;return o?(o=Sf(o),o.startsWith("/")?m=mf(o.substring(1),"/"):m=mf(o,d)):m=d,{pathname:m,search:Hm(u),hash:Um(f)}}function mf(r,d){let o=is(d).split("/");return r.split("/").forEach(f=>{f===".."?o.length>1&&o.pop():f!=="."&&o.push(f)}),o.length>1?o.join("/"):"/"}function Lu(r,d,o,u){return`Cannot include a '${r}' character in a manually specified \`to.${d}\` field [${JSON.stringify(u)}].  Please separate it out to the \`to.${o}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function km(r){return r.filter((d,o)=>o===0||d.route.path&&d.route.path.length>0)}function Yu(r){let d=km(r);return d.map((o,u)=>u===d.length-1?o.pathname:o.pathnameBase)}function ss(r,d,o,u=!1){let f;typeof r=="string"?f=La(r):(f={...r},wt(!f.pathname||!f.pathname.includes("?"),Lu("?","pathname","search",f)),wt(!f.pathname||!f.pathname.includes("#"),Lu("#","pathname","hash",f)),wt(!f.search||!f.search.includes("#"),Lu("#","search","hash",f)));let m=r===""||f.pathname==="",g=m?"/":f.pathname,E;if(g==null)E=o;else{let w=d.length-1;if(!u&&g.startsWith("..")){let O=g.split("/");for(;O[0]==="..";)O.shift(),w-=1;f.pathname=O.join("/")}E=w>=0?d[w]:"/"}let b=Om(f,E),y=g&&g!=="/"&&g.endsWith("/"),R=(m||g===".")&&o.endsWith("/");return!b.pathname.endsWith("/")&&(y||R)&&(b.pathname+="/"),b}var Sf=r=>r.replace(/[\\/]{2,}/g,"/"),Ce=r=>Sf(r.join("/")),is=r=>r.replace(/\/+$/,""),Dm=r=>is(r).replace(/^\/*/,"/"),Hm=r=>!r||r==="?"?"":r.startsWith("?")?r:"?"+r,Um=r=>!r||r==="#"?"":r.startsWith("#")?r:"#"+r,qm=class{constructor(r,d,o,u=!1){this.status=r,this.statusText=d||"",this.internal=u,o instanceof Error?(this.data=o.toString(),this.error=o):this.data=o}};function jm(r){return r!=null&&typeof r.status=="number"&&typeof r.statusText=="string"&&typeof r.internal=="boolean"&&"data"in r}function Ym(r){let d=r.map(o=>o.route.path).filter(Boolean);return Ce(d)||"/"}var Ef=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function Tf(r,d){let o=r;if(typeof o!="string"||!ju.test(o))return{absoluteURL:void 0,isExternal:!1,to:o};let u=o,f=!1;if(Ef)try{let m=new URL(window.location.href),g=vf.test(o)?new URL(vm(o,m.protocol)):new URL(o),E=ln(g.pathname,d);g.origin===m.origin&&E!=null?o=E+g.search+g.hash:f=!0}catch{Me(!1,`<Link to="${o}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:u,isExternal:f,to:o}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var wf=["POST","PUT","PATCH","DELETE"];new Set(wf);var Gm=["GET",...wf];new Set(Gm);var Zm=["about:","blob:","chrome:","chrome-untrusted:","content:","data:","devtools:","file:","filesystem:","javascript:"];function Xm(r){try{return Zm.includes(new URL(r).protocol)}catch{return!1}}var Oa=N.createContext(null);Oa.displayName="DataRouter";var rs=N.createContext(null);rs.displayName="DataRouterState";var Rf=N.createContext(!1);function Vm(){return N.useContext(Rf)}var Nf=N.createContext({isTransitioning:!1});Nf.displayName="ViewTransition";var Qm=N.createContext(new Map);Qm.displayName="Fetchers";var Km=N.createContext(null);Km.displayName="Await";var me=N.createContext(null);me.displayName="Navigation";var Ol=N.createContext(null);Ol.displayName="Location";var Be=N.createContext({outlet:null,matches:[],isDataRoute:!1});Be.displayName="Route";var Gu=N.createContext(null);Gu.displayName="RouteError";var zf="REACT_ROUTER_ERROR",Jm="REDIRECT",$m="ROUTE_ERROR_RESPONSE";function Im(r){if(r.startsWith(`${zf}:${Jm}:{`))try{let d=JSON.parse(r.slice(28));if(typeof d=="object"&&d&&typeof d.status=="number"&&typeof d.statusText=="string"&&typeof d.location=="string"&&typeof d.reloadDocument=="boolean"&&typeof d.replace=="boolean")return d}catch{}}function Fm(r){if(r.startsWith(`${zf}:${$m}:{`))try{let d=JSON.parse(r.slice(40));if(typeof d=="object"&&d&&typeof d.status=="number"&&typeof d.statusText=="string")return new qm(d.status,d.statusText,d.data)}catch{}}function Pm(r,{relative:d}={}){wt(ka(),"useHref() may be used only in the context of a <Router> component.");let{basename:o,navigator:u}=N.useContext(me),{hash:f,pathname:m,search:g}=kl(r,{relative:d}),E=m;return o!=="/"&&(E=m==="/"?o:Ce([o,m])),u.createHref({pathname:E,search:g,hash:f})}function ka(){return N.useContext(Ol)!=null}function Ue(){return wt(ka(),"useLocation() may be used only in the context of a <Router> component."),N.useContext(Ol).location}var Cf="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Mf(r){N.useContext(me).static||N.useLayoutEffect(r)}function Bf(){let{isDataRoute:r}=N.useContext(Be);return r?mh():th()}function th(){wt(ka(),"useNavigate() may be used only in the context of a <Router> component.");let r=N.useContext(Oa),{basename:d,navigator:o}=N.useContext(me),{matches:u}=N.useContext(Be),{pathname:f}=Ue(),m=JSON.stringify(Yu(u)),g=N.useRef(!1);return Mf(()=>{g.current=!0}),N.useCallback((b,y={})=>{if(Me(g.current,Cf),!g.current)return;if(typeof b=="number"){o.go(b);return}let R=ss(b,JSON.parse(m),f,y.relative==="path");r==null&&d!=="/"&&(R.pathname=R.pathname==="/"?d:Ce([d,R.pathname])),(y.replace?o.replace:o.push)(R,y.state,y)},[d,o,m,f,r])}var eh=N.createContext(null);function nh(r){let d=N.useContext(Be).outlet;return N.useMemo(()=>d&&N.createElement(eh.Provider,{value:r},d),[d,r])}function kl(r,{relative:d}={}){let{matches:o}=N.useContext(Be),{pathname:u}=Ue(),f=JSON.stringify(Yu(o));return N.useMemo(()=>ss(r,JSON.parse(f),u,d==="path"),[r,f,u,d])}function ah(r,d){return Wf(r,d)}function Wf(r,d,o){var j;wt(ka(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:u}=N.useContext(me),{matches:f}=N.useContext(Be),m=f[f.length-1],g=m?m.params:{},E=m?m.pathname:"/",b=m?m.pathnameBase:"/",y=m&&m.route;{let D=y&&y.path||"";Of(E,!y||D.endsWith("*")||D.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${E}" (under <Route path="${D}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${D}"> to <Route path="${D==="/"?"*":`${D}/*`}">.`)}let R=Ue(),w;if(d){let D=typeof d=="string"?La(d):d;wt(b==="/"||((j=D.pathname)==null?void 0:j.startsWith(b)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${b}" but pathname "${D.pathname}" was given in the \`location\` prop.`),w=D}else w=R;let O=w.pathname||"/",Z=O;if(b!=="/"){let D=b.replace(/^\//,"").split("/");Z="/"+O.replace(/^\//,"").split("/").slice(D.length).join("/")}let X=o&&o.state.matches.length?o.state.matches.map(D=>Object.assign(D,{route:o.manifest[D.route.id]||D.route})):xf(r,{pathname:Z});Me(y||X!=null,`No routes matched location "${w.pathname}${w.search}${w.hash}" `),Me(X==null||X[X.length-1].route.element!==void 0||X[X.length-1].route.Component!==void 0||X[X.length-1].route.lazy!==void 0,`Matched leaf route at location "${w.pathname}${w.search}${w.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let U=uh(X&&X.map(D=>Object.assign({},D,{params:Object.assign({},g,D.params),pathname:Ce([b,u.encodeLocation?u.encodeLocation(D.pathname.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:D.pathname]),pathnameBase:D.pathnameBase==="/"?b:Ce([b,u.encodeLocation?u.encodeLocation(D.pathnameBase.replace(/%/g,"%25").replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:D.pathnameBase])})),f,o);return d&&U?N.createElement(Ol.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",mask:void 0,...w},navigationType:"POP"}},U):U}function lh(){let r=ph(),d=jm(r)?`${r.status} ${r.statusText}`:r instanceof Error?r.message:JSON.stringify(r),o=r instanceof Error?r.stack:null,u="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:u},m={padding:"2px 4px",backgroundColor:u},g=null;return console.error("Error handled by React Router default ErrorBoundary:",r),g=N.createElement(N.Fragment,null,N.createElement("p",null,"💿 Hey developer 👋"),N.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",N.createElement("code",{style:m},"ErrorBoundary")," or"," ",N.createElement("code",{style:m},"errorElement")," prop on your route.")),N.createElement(N.Fragment,null,N.createElement("h2",null,"Unexpected Application Error!"),N.createElement("h3",{style:{fontStyle:"italic"}},d),o?N.createElement("pre",{style:f},o):null,g)}var ih=N.createElement(lh,null),Lf=class extends N.Component{constructor(r){super(r),this.state={location:r.location,revalidation:r.revalidation,error:r.error}}static getDerivedStateFromError(r){return{error:r}}static getDerivedStateFromProps(r,d){return d.location!==r.location||d.revalidation!=="idle"&&r.revalidation==="idle"?{error:r.error,location:r.location,revalidation:r.revalidation}:{error:r.error!==void 0?r.error:d.error,location:d.location,revalidation:r.revalidation||d.revalidation}}componentDidCatch(r,d){this.props.onError?this.props.onError(r,d):console.error("React Router caught the following error during render",r)}render(){let r=this.state.error;if(this.context&&typeof r=="object"&&r&&"digest"in r&&typeof r.digest=="string"){const o=Fm(r.digest);o&&(r=o)}let d=r!==void 0?N.createElement(Be.Provider,{value:this.props.routeContext},N.createElement(Gu.Provider,{value:r,children:this.props.component})):this.props.children;return this.context?N.createElement(sh,{error:r},d):d}};Lf.contextType=Rf;var Ou=new WeakMap;function sh({children:r,error:d}){let{basename:o}=N.useContext(me);if(typeof d=="object"&&d&&"digest"in d&&typeof d.digest=="string"){let u=Im(d.digest);if(u){let f=Ou.get(d);if(f)throw f;let m=Tf(u.location,o),g=m.absoluteURL||m.to;if(Xm(g))throw new Error("Invalid redirect location");if(Ef&&!Ou.get(d))if(m.isExternal||u.reloadDocument)window.location.href=g;else{const E=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(m.to,{replace:u.replace}));throw Ou.set(d,E),E}return N.createElement("meta",{httpEquiv:"refresh",content:`0;url=${g}`})}}return r}function rh({routeContext:r,match:d,children:o}){let u=N.useContext(Oa);return u&&u.static&&u.staticContext&&(d.route.errorElement||d.route.ErrorBoundary)&&(u.staticContext._deepestRenderedBoundaryId=d.route.id),N.createElement(Be.Provider,{value:r},o)}function uh(r,d=[],o){let u=o==null?void 0:o.state;if(r==null){if(!u)return null;if(u.errors)r=u.matches;else if(d.length===0&&!u.initialized&&u.matches.length>0)r=u.matches;else return null}let f=r,m=u==null?void 0:u.errors;if(m!=null){let R=f.findIndex(w=>w.route.id&&(m==null?void 0:m[w.route.id])!==void 0);wt(R>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(m).join(",")}`),f=f.slice(0,Math.min(f.length,R+1))}let g=!1,E=-1;if(o&&u){g=u.renderFallback;for(let R=0;R<f.length;R++){let w=f[R];if((w.route.HydrateFallback||w.route.hydrateFallbackElement)&&(E=R),w.route.id){let{loaderData:O,errors:Z}=u,X=w.route.loader&&!O.hasOwnProperty(w.route.id)&&(!Z||Z[w.route.id]===void 0);if(w.route.lazy||X){o.isStatic&&(g=!0),E>=0?f=f.slice(0,E+1):f=[f[0]];break}}}}let b=o==null?void 0:o.onError,y=u&&b?(R,w)=>{var O,Z;b(R,{location:u.location,params:((Z=(O=u.matches)==null?void 0:O[0])==null?void 0:Z.params)??{},pattern:Ym(u.matches),errorInfo:w})}:void 0;return f.reduceRight((R,w,O)=>{let Z,X=!1,U=null,j=null;u&&(Z=m&&w.route.id?m[w.route.id]:void 0,U=w.route.errorElement||ih,g&&(E<0&&O===0?(Of("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),X=!0,j=null):E===O&&(X=!0,j=w.route.hydrateFallbackElement||null)));let D=d.concat(f.slice(0,O+1)),F=()=>{let K;return Z?K=U:X?K=j:w.route.Component?K=N.createElement(w.route.Component,null):w.route.element?K=w.route.element:K=R,N.createElement(rh,{match:w,routeContext:{outlet:R,matches:D,isDataRoute:u!=null},children:K})};return u&&(w.route.ErrorBoundary||w.route.errorElement||O===0)?N.createElement(Lf,{location:u.location,revalidation:u.revalidation,component:U,error:Z,children:F(),routeContext:{outlet:null,matches:D,isDataRoute:!0},onError:y}):F()},null)}function Zu(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ch(r){let d=N.useContext(Oa);return wt(d,Zu(r)),d}function dh(r){let d=N.useContext(rs);return wt(d,Zu(r)),d}function oh(r){let d=N.useContext(Be);return wt(d,Zu(r)),d}function Xu(r){let d=oh(r),o=d.matches[d.matches.length-1];return wt(o.route.id,`${r} can only be used on routes that contain a unique "id"`),o.route.id}function fh(){return Xu("useRouteId")}function ph(){var u;let r=N.useContext(Gu),d=dh("useRouteError"),o=Xu("useRouteError");return r!==void 0?r:(u=d.errors)==null?void 0:u[o]}function mh(){let{router:r}=ch("useNavigate"),d=Xu("useNavigate"),o=N.useRef(!1);return Mf(()=>{o.current=!0}),N.useCallback(async(f,m={})=>{Me(o.current,Cf),o.current&&(typeof f=="number"?await r.navigate(f):await r.navigate(f,{fromRouteId:d,...m}))},[r,d])}var hf={};function Of(r,d,o){!d&&!hf[r]&&(hf[r]=!0,Me(!1,o))}N.memo(hh);function hh({routes:r,manifest:d,future:o,state:u,isStatic:f,onError:m}){return Wf(r,void 0,{manifest:d,state:u,isStatic:f,onError:m})}function yh({to:r,replace:d,state:o,relative:u}){wt(ka(),"<Navigate> may be used only in the context of a <Router> component.");let{static:f}=N.useContext(me);Me(!f,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:m}=N.useContext(Be),{pathname:g}=Ue(),E=Bf(),b=ss(r,Yu(m),g,u==="path"),y=JSON.stringify(b);return N.useEffect(()=>{E(JSON.parse(y),{replace:d,state:o,relative:u})},[E,y,u,d,o]),null}function vh(r){return nh(r.context)}function Wl(r){wt(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function xh({basename:r="/",children:d=null,location:o,navigationType:u="POP",navigator:f,static:m=!1,useTransitions:g}){wt(!ka(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let E=r.replace(/^\/*/,"/"),b=N.useMemo(()=>({basename:E,navigator:f,static:m,useTransitions:g,future:{}}),[E,f,m,g]);typeof o=="string"&&(o=La(o));let{pathname:y="/",search:R="",hash:w="",state:O=null,key:Z="default",mask:X}=o,U=N.useMemo(()=>{let j=ln(y,E);return j==null?null:{location:{pathname:j,search:R,hash:w,state:O,key:Z,mask:X},navigationType:u}},[E,y,R,w,O,Z,u,X]);return Me(U!=null,`<Router basename="${E}"> is not able to match the URL "${y}${R}${w}" because it does not start with the basename, so the <Router> won't render anything.`),U==null?null:N.createElement(me.Provider,{value:b},N.createElement(Ol.Provider,{children:d,value:U}))}function gh({children:r,location:d}){return ah(Hu(r),d)}function Hu(r,d=[]){let o=[];return N.Children.forEach(r,(u,f)=>{if(!N.isValidElement(u))return;let m=[...d,f];if(u.type===N.Fragment){o.push.apply(o,Hu(u.props.children,m));return}wt(u.type===Wl,`[${typeof u.type=="string"?u.type:u.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),wt(!u.props.index||!u.props.children,"An index route cannot have child routes.");let g={id:u.props.id||m.join("-"),caseSensitive:u.props.caseSensitive,element:u.props.element,Component:u.props.Component,index:u.props.index,path:u.props.path,middleware:u.props.middleware,loader:u.props.loader,action:u.props.action,hydrateFallbackElement:u.props.hydrateFallbackElement,HydrateFallback:u.props.HydrateFallback,errorElement:u.props.errorElement,ErrorBoundary:u.props.ErrorBoundary,hasErrorBoundary:u.props.hasErrorBoundary===!0||u.props.ErrorBoundary!=null||u.props.errorElement!=null,shouldRevalidate:u.props.shouldRevalidate,handle:u.props.handle,lazy:u.props.lazy};u.props.children&&(g.children=Hu(u.props.children,m)),o.push(g)}),o}var ns="get",as="application/x-www-form-urlencoded";function us(r){return typeof HTMLElement<"u"&&r instanceof HTMLElement}function bh(r){return us(r)&&r.tagName.toLowerCase()==="button"}function _h(r){return us(r)&&r.tagName.toLowerCase()==="form"}function Ah(r){return us(r)&&r.tagName.toLowerCase()==="input"}function Sh(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function Eh(r,d){return r.button===0&&(!d||d==="_self")&&!Sh(r)}var es=null;function Th(){if(es===null)try{new FormData(document.createElement("form"),0),es=!1}catch{es=!0}return es}var wh=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function ku(r){return r!=null&&!wh.has(r)?(Me(!1,`"${r}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${as}"`),null):r}function Rh(r,d){let o,u,f,m,g;if(_h(r)){let E=r.getAttribute("action");u=E?ln(E,d):null,o=r.getAttribute("method")||ns,f=ku(r.getAttribute("enctype"))||as,m=new FormData(r)}else if(bh(r)||Ah(r)&&(r.type==="submit"||r.type==="image")){let E=r.form;if(E==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=r.getAttribute("formaction")||E.getAttribute("action");if(u=b?ln(b,d):null,o=r.getAttribute("formmethod")||E.getAttribute("method")||ns,f=ku(r.getAttribute("formenctype"))||ku(E.getAttribute("enctype"))||as,m=new FormData(E,r),!Th()){let{name:y,type:R,value:w}=r;if(R==="image"){let O=y?`${y}.`:"";m.append(`${O}x`,"0"),m.append(`${O}y`,"0")}else y&&m.append(y,w)}}else{if(us(r))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');o=ns,u=null,f=as,g=r}return m&&f==="text/plain"&&(g=m,m=void 0),{action:u,method:o.toLowerCase(),encType:f,formData:m,body:g}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Vu(r,d){if(r===!1||r===null||typeof r>"u")throw new Error(d)}function kf(r,d,o,u){let f=typeof r=="string"?new URL(r,typeof window>"u"?"server://singlefetch/":window.location.origin):r;return o?f.pathname.endsWith("/")?f.pathname=`${f.pathname}_.${u}`:f.pathname=`${f.pathname}.${u}`:f.pathname==="/"?f.pathname=`_root.${u}`:d&&ln(f.pathname,d)==="/"?f.pathname=`${is(d)}/_root.${u}`:f.pathname=`${is(f.pathname)}.${u}`,f}async function Nh(r,d){if(r.id in d)return d[r.id];try{let o=await import(r.module);return d[r.id]=o,o}catch(o){return console.error(`Error loading route module \`${r.module}\`, reloading page...`),console.error(o),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function zh(r){return r==null?!1:r.href==null?r.rel==="preload"&&typeof r.imageSrcSet=="string"&&typeof r.imageSizes=="string":typeof r.rel=="string"&&typeof r.href=="string"}async function Ch(r,d,o){let u=await Promise.all(r.map(async f=>{let m=d.routes[f.route.id];if(m){let g=await Nh(m,o);return g.links?g.links():[]}return[]}));return Lh(u.flat(1).filter(zh).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function yf(r,d,o,u,f,m){let g=(b,y)=>o[y]?b.route.id!==o[y].route.id:!0,E=(b,y)=>{var R;return o[y].pathname!==b.pathname||((R=o[y].route.path)==null?void 0:R.endsWith("*"))&&o[y].params["*"]!==b.params["*"]};return m==="assets"?d.filter((b,y)=>g(b,y)||E(b,y)):m==="data"?d.filter((b,y)=>{var w;let R=u.routes[b.route.id];if(!R||!R.hasLoader)return!1;if(g(b,y)||E(b,y))return!0;if(b.route.shouldRevalidate){let O=b.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:((w=o[0])==null?void 0:w.params)||{},nextUrl:new URL(r,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof O=="boolean")return O}return!0}):[]}function Mh(r,d,{includeHydrateFallback:o}={}){return Bh(r.map(u=>{let f=d.routes[u.route.id];if(!f)return[];let m=[f.module];return f.clientActionModule&&(m=m.concat(f.clientActionModule)),f.clientLoaderModule&&(m=m.concat(f.clientLoaderModule)),o&&f.hydrateFallbackModule&&(m=m.concat(f.hydrateFallbackModule)),f.imports&&(m=m.concat(f.imports)),m}).flat(1))}function Bh(r){return[...new Set(r)]}function Wh(r){let d={},o=Object.keys(r).sort();for(let u of o)d[u]=r[u];return d}function Lh(r,d){let o=new Set;return new Set(d),r.reduce((u,f)=>{let m=JSON.stringify(Wh(f));return o.has(m)||(o.add(m),u.push({key:m,link:f})),u},[])}function Qu(){let r=N.useContext(Oa);return Vu(r,"You must render this element inside a <DataRouterContext.Provider> element"),r}function Oh(){let r=N.useContext(rs);return Vu(r,"You must render this element inside a <DataRouterStateContext.Provider> element"),r}var Ku=N.createContext(void 0);Ku.displayName="FrameworkContext";function cs(){let r=N.useContext(Ku);return Vu(r,"You must render this element inside a <HydratedRouter> element"),r}function kh(r,d){let o=N.useContext(Ku),[u,f]=N.useState(!1),[m,g]=N.useState(!1),{onFocus:E,onBlur:b,onMouseEnter:y,onMouseLeave:R,onTouchStart:w}=d,O=N.useRef(null);N.useEffect(()=>{if(r==="render"&&g(!0),r==="viewport"){let U=D=>{D.forEach(F=>{g(F.isIntersecting)})},j=new IntersectionObserver(U,{threshold:.5});return O.current&&j.observe(O.current),()=>{j.disconnect()}}},[r]),N.useEffect(()=>{if(u){let U=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(U)}}},[u]);let Z=()=>{f(!0)},X=()=>{f(!1),g(!1)};return o?r!=="intent"?[m,O,{}]:[m,O,{onFocus:Bl(E,Z),onBlur:Bl(b,X),onMouseEnter:Bl(y,Z),onMouseLeave:Bl(R,X),onTouchStart:Bl(w,Z)}]:[!1,O,{}]}function Bl(r,d){return o=>{r&&r(o),o.defaultPrevented||d(o)}}function Dh({page:r,...d}){let o=Vm(),{nonce:u}=cs(),{router:f}=Qu(),m=N.useMemo(()=>xf(f.routes,r,f.basename),[f.routes,r,f.basename]);return m?(d.nonce==null&&u&&(d={...d,nonce:u}),o?N.createElement(Uh,{page:r,matches:m,...d}):N.createElement(qh,{page:r,matches:m,...d})):null}function Hh(r){let{manifest:d,routeModules:o}=cs(),[u,f]=N.useState([]);return N.useEffect(()=>{let m=!1;return Ch(r,d,o).then(g=>{m||f(g)}),()=>{m=!0}},[r,d,o]),u}function Uh({page:r,matches:d,...o}){let u=Ue(),{future:f}=cs(),{basename:m}=Qu(),g=N.useMemo(()=>{if(r===u.pathname+u.search+u.hash)return[];let E=kf(r,m,f.v8_trailingSlashAwareDataRequests,"rsc"),b=!1,y=[];for(let R of d)typeof R.route.shouldRevalidate=="function"?b=!0:y.push(R.route.id);return b&&y.length>0&&E.searchParams.set("_routes",y.join(",")),[E.pathname+E.search]},[m,f.v8_trailingSlashAwareDataRequests,r,u,d]);return N.createElement(N.Fragment,null,g.map(E=>N.createElement("link",{key:E,rel:"prefetch",as:"fetch",href:E,...o})))}function qh({page:r,matches:d,...o}){let u=Ue(),{future:f,manifest:m,routeModules:g}=cs(),{basename:E}=Qu(),{loaderData:b,matches:y}=Oh(),R=N.useMemo(()=>yf(r,d,y,m,u,"data"),[r,d,y,m,u]),w=N.useMemo(()=>yf(r,d,y,m,u,"assets"),[r,d,y,m,u]),O=N.useMemo(()=>{if(r===u.pathname+u.search+u.hash)return[];let U=new Set,j=!1;if(d.forEach(F=>{var ht;let K=m.routes[F.route.id];!K||!K.hasLoader||(!R.some(ft=>ft.route.id===F.route.id)&&F.route.id in b&&((ht=g[F.route.id])!=null&&ht.shouldRevalidate)||K.hasClientLoader?j=!0:U.add(F.route.id))}),U.size===0)return[];let D=kf(r,E,f.v8_trailingSlashAwareDataRequests,"data");return j&&U.size>0&&D.searchParams.set("_routes",d.filter(F=>U.has(F.route.id)).map(F=>F.route.id).join(",")),[D.pathname+D.search]},[E,f.v8_trailingSlashAwareDataRequests,b,u,m,R,d,r,g]),Z=N.useMemo(()=>Mh(w,m),[w,m]),X=Hh(w);return N.createElement(N.Fragment,null,O.map(U=>N.createElement("link",{key:U,rel:"prefetch",as:"fetch",href:U,...o})),Z.map(U=>N.createElement("link",{key:U,rel:"modulepreload",href:U,...o})),X.map(({key:U,link:j})=>N.createElement("link",{key:U,nonce:o.nonce,...j,crossOrigin:j.crossOrigin??o.crossOrigin})))}function jh(...r){return d=>{r.forEach(o=>{typeof o=="function"?o(d):o!=null&&(o.current=d)})}}var Yh=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Yh&&(window.__reactRouterVersion="7.18.0")}catch{}function Gh({basename:r,children:d,useTransitions:o,window:u}){let f=N.useRef();f.current==null&&(f.current=xm({window:u,v5Compat:!0}));let m=f.current,[g,E]=N.useState({action:m.action,location:m.location}),b=N.useCallback(y=>{o===!1?E(y):N.startTransition(()=>E(y))},[o]);return N.useLayoutEffect(()=>m.listen(b),[m,b]),N.createElement(xh,{basename:r,children:d,location:g.location,navigationType:g.action,navigator:m,useTransitions:o})}var Ju=N.forwardRef(function({onClick:d,discover:o="render",prefetch:u="none",relative:f,reloadDocument:m,replace:g,mask:E,state:b,target:y,to:R,preventScrollReset:w,viewTransition:O,defaultShouldRevalidate:Z,...X},U){let{basename:j,navigator:D,useTransitions:F}=N.useContext(me),K=typeof R=="string"&&ju.test(R),ht=Tf(R,j);R=ht.to;let ft=Pm(R,{relative:f}),At=Ue(),$=null;if(E){let Wt=ss(E,[],At.mask?At.mask.pathname:"/",!0);j!=="/"&&(Wt.pathname=Wt.pathname==="/"?j:Ce([j,Wt.pathname])),$=D.createHref(Wt)}let[zt,Vt,We]=kh(u,X),he=Vh(R,{replace:g,mask:E,state:b,target:y,preventScrollReset:w,relative:f,viewTransition:O,defaultShouldRevalidate:Z,useTransitions:F});function Qt(Wt){d&&d(Wt),Wt.defaultPrevented||he(Wt)}let Le=!(ht.isExternal||m),ye=N.createElement("a",{...X,...We,href:(Le?$:void 0)||ht.absoluteURL||ft,onClick:Le?Qt:d,ref:jh(U,Vt),target:y,"data-discover":!K&&o==="render"?"true":void 0});return zt&&!K?N.createElement(N.Fragment,null,ye,N.createElement(Dh,{page:ft})):ye});Ju.displayName="Link";var Uu=N.forwardRef(function({"aria-current":d="page",caseSensitive:o=!1,className:u="",end:f=!1,style:m,to:g,viewTransition:E,children:b,...y},R){let w=kl(g,{relative:y.relative}),O=Ue(),Z=N.useContext(rs),{navigator:X,basename:U}=N.useContext(me),j=Z!=null&&Ih(w)&&E===!0,D=X.encodeLocation?X.encodeLocation(w).pathname:w.pathname,F=O.pathname,K=Z&&Z.navigation&&Z.navigation.location?Z.navigation.location.pathname:null;o||(F=F.toLowerCase(),K=K?K.toLowerCase():null,D=D.toLowerCase()),K&&U&&(K=ln(K,U)||K);const ht=D!=="/"&&D.endsWith("/")?D.length-1:D.length;let ft=F===D||!f&&F.startsWith(D)&&F.charAt(ht)==="/",At=K!=null&&(K===D||!f&&K.startsWith(D)&&K.charAt(D.length)==="/"),$={isActive:ft,isPending:At,isTransitioning:j},zt=ft?d:void 0,Vt;typeof u=="function"?Vt=u($):Vt=[u,ft?"active":null,At?"pending":null,j?"transitioning":null].filter(Boolean).join(" ");let We=typeof m=="function"?m($):m;return N.createElement(Ju,{...y,"aria-current":zt,className:Vt,ref:R,style:We,to:g,viewTransition:E},typeof b=="function"?b($):b)});Uu.displayName="NavLink";var Zh=N.forwardRef(({discover:r="render",fetcherKey:d,navigate:o,reloadDocument:u,replace:f,state:m,method:g=ns,action:E,onSubmit:b,relative:y,preventScrollReset:R,viewTransition:w,defaultShouldRevalidate:O,...Z},X)=>{let{useTransitions:U}=N.useContext(me),j=Jh(),D=$h(E,{relative:y}),F=g.toLowerCase()==="get"?"get":"post",K=typeof E=="string"&&ju.test(E),ht=ft=>{if(b&&b(ft),ft.defaultPrevented)return;ft.preventDefault();let At=ft.nativeEvent.submitter,$=(At==null?void 0:At.getAttribute("formmethod"))||g,zt=()=>j(At||ft.currentTarget,{fetcherKey:d,method:$,navigate:o,replace:f,state:m,relative:y,preventScrollReset:R,viewTransition:w,defaultShouldRevalidate:O});U&&o!==!1?N.startTransition(()=>zt()):zt()};return N.createElement("form",{ref:X,method:F,action:D,onSubmit:u?b:ht,...Z,"data-discover":!K&&r==="render"?"true":void 0})});Zh.displayName="Form";function Xh(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Df(r){let d=N.useContext(Oa);return wt(d,Xh(r)),d}function Vh(r,{target:d,replace:o,mask:u,state:f,preventScrollReset:m,relative:g,viewTransition:E,defaultShouldRevalidate:b,useTransitions:y}={}){let R=Bf(),w=Ue(),O=kl(r,{relative:g});return N.useCallback(Z=>{if(Eh(Z,d)){Z.preventDefault();let X=o!==void 0?o:Ll(w)===Ll(O),U=()=>R(r,{replace:X,mask:u,state:f,preventScrollReset:m,relative:g,viewTransition:E,defaultShouldRevalidate:b});y?N.startTransition(()=>U()):U()}},[w,R,O,o,u,f,d,r,m,g,E,b,y])}var Qh=0,Kh=()=>`__${String(++Qh)}__`;function Jh(){let{router:r}=Df("useSubmit"),{basename:d}=N.useContext(me),o=fh(),u=r.fetch,f=r.navigate;return N.useCallback(async(m,g={})=>{let{action:E,method:b,encType:y,formData:R,body:w}=Rh(m,d);if(g.navigate===!1){let O=g.fetcherKey||Kh();await u(O,o,g.action||E,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:R,body:w,formMethod:g.method||b,formEncType:g.encType||y,flushSync:g.flushSync})}else await f(g.action||E,{defaultShouldRevalidate:g.defaultShouldRevalidate,preventScrollReset:g.preventScrollReset,formData:R,body:w,formMethod:g.method||b,formEncType:g.encType||y,replace:g.replace,state:g.state,fromRouteId:o,flushSync:g.flushSync,viewTransition:g.viewTransition})},[u,f,d,o])}function $h(r,{relative:d}={}){let{basename:o}=N.useContext(me),u=N.useContext(Be);wt(u,"useFormAction must be used inside a RouteContext");let[f]=u.matches.slice(-1),m={...kl(r||".",{relative:d})},g=Ue();if(r==null){m.search=g.search;let E=new URLSearchParams(m.search),b=E.getAll("index");if(b.some(R=>R==="")){E.delete("index"),b.filter(w=>w).forEach(w=>E.append("index",w));let R=E.toString();m.search=R?`?${R}`:""}}return(!r||r===".")&&f.route.index&&(m.search=m.search?m.search.replace(/^\?/,"?index&"):"?index"),o!=="/"&&(m.pathname=m.pathname==="/"?o:Ce([o,m.pathname])),Ll(m)}function Ih(r,{relative:d}={}){let o=N.useContext(Nf);wt(o!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:u}=Df("useViewTransitionState"),f=kl(r,{relative:d});if(!o.isTransitioning)return!1;let m=ln(o.currentLocation.pathname,u)||o.currentLocation.pathname,g=ln(o.nextLocation.pathname,u)||o.nextLocation.pathname;return ls(f.pathname,g)!=null||ls(f.pathname,m)!=null}const Fh=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="wrap">
  ...
  <h1>Comparing vectors, step by step</h1>
...
`,$u=[{slug:"comparing-vectors",title:"Comparing vectors",shortTitle:"Vectors",description:"Cosine similarity (the angle) for two vectors and two matrices, plus Euclidean distance (the straight-line gap).",tag:"cosine · distance",symbol:"∠",source:Fh},{slug:"matrix-multiplication",title:"Matrix multiplication",shortTitle:"Matrices",description:"Row-by-column dot products building the product matrix, cell by cell — A(3×5) × B(5×3) = C(3×3).",tag:"linear algebra",symbol:"A×B",source:Ph},{slug:"softmax",title:"Softmax",shortTitle:"Softmax",description:"Logits → exponentiate → normalize into a probability distribution, with a live temperature slider to sharpen or flatten it.",tag:"probabilities · temperature",symbol:"σ",source:t2},{slug:"neural-network",title:"Neural network training",shortTitle:"Neural network",description:"A small network's forward pass and backpropagation — activations flowing forward, gradients flowing back.",tag:"forward · backprop",symbol:"→",source:e2},{slug:"recurrent-neural-network",title:"Recurrent neural network",shortTitle:"RNN",description:"A 2-layer stacked RNN unrolled over a sequence — hidden state carried across time steps in each layer, trained with backprop-through-time.",tag:"2 layers · BPTT",symbol:"↻",source:n2},{slug:"llm-inference",title:"LLM inference",shortTitle:"LLM inference",description:"The full next-word pipeline: vocabulary, embeddings, positional encoding, attention, logits, softmax + temperature, and autoregressive generation.",tag:"transformers · generation",symbol:"T",source:a2},{slug:"debiasing",title:"Debiasing embeddings",shortTitle:"Debiasing",description:"Neutralizing a word vector: project onto the bias direction g and subtract it, leaving a vector orthogonal to g.",tag:"projection · fairness",symbol:"⊥",source:l2}],i2=[112,99,64,112,101,116,114,111,110,101,108,108,97,46,97,116].map(r=>String.fromCharCode(r)).join("");function s2(){return W.jsxs("div",{className:"app-shell",children:[W.jsx("header",{className:"app-header",children:W.jsxs("nav",{className:"app-nav","aria-label":"Animations",children:[W.jsx(Uu,{className:"brand",to:"/",children:"ML animations"}),W.jsx("div",{className:"nav-links",children:$u.map(({slug:r,shortTitle:d})=>W.jsx(Uu,{to:`/${r}`,children:d},r))})]})}),W.jsx(vh,{}),W.jsxs("footer",{className:"catalog-footer",children:[W.jsx("span",{children:"Contact:"}),W.jsx("a",{className:"email-link",href:`mailto:${i2}`,"aria-label":"Send an email",title:"Send an email",children:W.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",children:[W.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"3"}),W.jsx("path",{d:"m5 8 7 5 7-5"})]})})]})]})}function r2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("line",{x1:"20",y1:"80",x2:"170",y2:"80",stroke:"#9aa3b8",strokeWidth:"1.5"}),W.jsx("line",{x1:"20",y1:"80",x2:"20",y2:"10",stroke:"#9aa3b8",strokeWidth:"1.5"}),W.jsx("line",{x1:"20",y1:"80",x2:"140",y2:"50",stroke:"#ff7a59",strokeWidth:"3"}),W.jsx("line",{x1:"20",y1:"80",x2:"90",y2:"15",stroke:"#4fd1c5",strokeWidth:"3"}),W.jsx("path",{d:"M 70 65 A 32 32 0 0 1 52 42",fill:"none",stroke:"#8b7bff",strokeWidth:"2.5"})]})}function u2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("rect",{x:"18",y:"28",width:"44",height:"44",rx:"4",fill:"#eef1f7",stroke:"#ff7a59"}),W.jsx("line",{x1:"32.7",y1:"28",x2:"32.7",y2:"72",stroke:"#ff7a59",strokeWidth:".8"}),W.jsx("line",{x1:"47.3",y1:"28",x2:"47.3",y2:"72",stroke:"#ff7a59",strokeWidth:".8"}),W.jsx("line",{x1:"18",y1:"42.7",x2:"62",y2:"42.7",stroke:"#ff7a59",strokeWidth:".8"}),W.jsx("line",{x1:"18",y1:"57.3",x2:"62",y2:"57.3",stroke:"#ff7a59",strokeWidth:".8"}),W.jsx("text",{x:"68",y:"55",fill:"#8a93a8",fontFamily:"monospace",fontSize:"16",children:"×"}),W.jsx("rect",{x:"82",y:"28",width:"44",height:"44",rx:"4",fill:"#eef1f7",stroke:"#4fd1c5"}),W.jsx("line",{x1:"96.7",y1:"28",x2:"96.7",y2:"72",stroke:"#4fd1c5",strokeWidth:".8"}),W.jsx("line",{x1:"111.3",y1:"28",x2:"111.3",y2:"72",stroke:"#4fd1c5",strokeWidth:".8"}),W.jsx("line",{x1:"82",y1:"42.7",x2:"126",y2:"42.7",stroke:"#4fd1c5",strokeWidth:".8"}),W.jsx("line",{x1:"82",y1:"57.3",x2:"126",y2:"57.3",stroke:"#4fd1c5",strokeWidth:".8"}),W.jsx("text",{x:"132",y:"55",fill:"#8a93a8",fontFamily:"monospace",fontSize:"16",children:"="}),W.jsx("rect",{x:"146",y:"34",width:"30",height:"30",rx:"4",fill:"#8b7bff"})]})}function c2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("rect",{x:"20",y:"20",width:"20",height:"60",rx:"3",fill:"#eef1f7",stroke:"#4fd1c5"}),W.jsx("rect",{x:"48",y:"40",width:"20",height:"40",rx:"3",fill:"#eef1f7",stroke:"#4fd1c5"}),W.jsx("text",{x:"74",y:"56",fill:"#8a93a8",fontFamily:"monospace",fontSize:"20",children:"→"}),W.jsx("rect",{x:"100",y:"26",width:"20",height:"54",rx:"3",fill:"#ffc846"}),W.jsx("rect",{x:"128",y:"50",width:"20",height:"30",rx:"3",fill:"#4fd1c5"}),W.jsx("rect",{x:"156",y:"64",width:"16",height:"16",rx:"3",fill:"#4fd1c5"})]})}function d2(){const r=[[40,30,90,22],[40,30,90,50],[40,30,90,78],[40,70,90,22],[40,70,90,50],[40,70,90,78],[90,22,140,50],[90,50,140,50],[90,78,140,50]];return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("g",{stroke:"#d8deea",strokeWidth:"1",children:r.map((d,o)=>W.jsx("line",{x1:d[0],y1:d[1],x2:d[2],y2:d[3]},o))}),W.jsxs("g",{fill:"#eef1f7",stroke:"#ff7a59",strokeWidth:"2",children:[W.jsx("circle",{cx:"40",cy:"30",r:"8"}),W.jsx("circle",{cx:"40",cy:"70",r:"8"})]}),W.jsxs("g",{fill:"#eef1f7",stroke:"#8b7bff",strokeWidth:"2",children:[W.jsx("circle",{cx:"90",cy:"22",r:"8"}),W.jsx("circle",{cx:"90",cy:"50",r:"8"}),W.jsx("circle",{cx:"90",cy:"78",r:"8"})]}),W.jsx("circle",{cx:"140",cy:"50",r:"8",fill:"#4fd1c5"})]})}function o2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("defs",{children:W.jsx("marker",{id:"rnnThumbArrow",markerWidth:"6",markerHeight:"6",refX:"5",refY:"3",orient:"auto",children:W.jsx("path",{d:"M0,0 L6,3 L0,6 Z",fill:"#4fd1c5"})})}),W.jsxs("g",{fill:"#eef1f7",stroke:"#8b7bff",strokeWidth:"2",children:[W.jsx("rect",{x:"20",y:"16",width:"30",height:"24",rx:"5"}),W.jsx("rect",{x:"75",y:"16",width:"30",height:"24",rx:"5"}),W.jsx("rect",{x:"130",y:"16",width:"30",height:"24",rx:"5"}),W.jsx("rect",{x:"20",y:"58",width:"30",height:"24",rx:"5"}),W.jsx("rect",{x:"75",y:"58",width:"30",height:"24",rx:"5"}),W.jsx("rect",{x:"130",y:"58",width:"30",height:"24",rx:"5"})]}),W.jsxs("g",{stroke:"#4fd1c5",strokeWidth:"2",fill:"none",markerEnd:"url(#rnnThumbArrow)",children:[W.jsx("line",{x1:"50",y1:"28",x2:"73",y2:"28"}),W.jsx("line",{x1:"105",y1:"28",x2:"128",y2:"28"}),W.jsx("line",{x1:"50",y1:"70",x2:"73",y2:"70"}),W.jsx("line",{x1:"105",y1:"70",x2:"128",y2:"70"})]}),W.jsxs("g",{stroke:"#ff7a59",strokeWidth:"2",fill:"none",children:[W.jsx("line",{x1:"35",y1:"58",x2:"35",y2:"42"}),W.jsx("line",{x1:"90",y1:"58",x2:"90",y2:"42"}),W.jsx("line",{x1:"145",y1:"58",x2:"145",y2:"42"})]})]})}function f2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("rect",{x:"14",y:"20",width:"26",height:"60",rx:"4",fill:"#eef1f7",stroke:"#ff7a59"}),W.jsx("rect",{x:"50",y:"20",width:"26",height:"60",rx:"4",fill:"#eef1f7",stroke:"#4fd1c5"}),W.jsx("rect",{x:"86",y:"20",width:"26",height:"60",rx:"4",fill:"#eef1f7",stroke:"#8b7bff"}),W.jsx("rect",{x:"128",y:"58",width:"14",height:"22",rx:"2",fill:"#4fd1c5"}),W.jsx("rect",{x:"146",y:"30",width:"14",height:"50",rx:"2",fill:"#ffc846"}),W.jsx("rect",{x:"164",y:"64",width:"10",height:"16",rx:"2",fill:"#4fd1c5"})]})}function p2(){return W.jsxs("svg",{viewBox:"0 0 180 100",role:"img","aria-hidden":"true",children:[W.jsx("line",{x1:"20",y1:"78",x2:"160",y2:"38",stroke:"#ffc846",strokeWidth:"2",strokeDasharray:"6 5"}),W.jsx("line",{x1:"60",y1:"80",x2:"120",y2:"22",stroke:"#ff7a59",strokeWidth:"3"}),W.jsx("line",{x1:"60",y1:"80",x2:"98",y2:"52",stroke:"#8b7bff",strokeWidth:"3"}),W.jsx("line",{x1:"60",y1:"80",x2:"78",y2:"34",stroke:"#4fd17a",strokeWidth:"3"}),W.jsx("line",{x1:"120",y1:"22",x2:"98",y2:"52",stroke:"#8a93a8",strokeWidth:"1.4",strokeDasharray:"4 4"})]})}const m2={"comparing-vectors":r2,"matrix-multiplication":u2,softmax:c2,"neural-network":d2,"recurrent-neural-network":o2,"llm-inference":f2,debiasing:p2};function h2({slug:r}){const d=m2[r];return W.jsx("div",{className:"thumbnail","aria-hidden":"true",children:W.jsx(d,{})})}function y2({animation:r}){return W.jsxs(Ju,{className:"catalog-card",to:`/${r.slug}`,children:[W.jsx(h2,{slug:r.slug}),W.jsx("h2",{children:r.title}),W.jsx("p",{children:r.description}),W.jsx("span",{className:"tag",children:r.tag})]})}function v2(){return W.jsxs("main",{className:"page home-page",children:[W.jsxs("header",{className:"hero",children:[W.jsx("h1",{children:"Machine-learning animations"}),W.jsx("p",{className:"intro",children:"Small, self-contained, interactive explainers for core machine-learning concepts."})]}),W.jsx("section",{className:"grid","aria-label":"Available animations",children:$u.map(r=>W.jsx(y2,{animation:r},r.slug))})]})}function x2(r){const d=new DOMParser().parseFromString(r,"text/html"),o=[...d.querySelectorAll("style")].map(R=>R.textContent),u=[...d.body.querySelectorAll("script")].filter(R=>!R.src).map(R=>R.textContent);d.querySelectorAll("site-nav, script").forEach(R=>R.remove());const m=d.body.querySelector(":scope > .wrap")||d.body,g=m.querySelector(":scope > h1"),E=m.querySelector(":scope > p.sub"),b=(g==null?void 0:g.textContent.trim())||"",y=(E==null?void 0:E.innerHTML)||"";return g==null||g.remove(),E==null||E.remove(),{intro:y,markup:m.innerHTML,scripts:u,styles:o,title:b}}function g2({animation:r}){const d=N.useRef(null),o=N.useMemo(()=>x2(r.source),[r.source]);return N.useEffect(()=>{document.title=`${r.title} | ML Animations`;const u=[],f=window.setInterval,m=window.setTimeout;window.setInterval=(...g)=>{const E=f(...g);return u.push(()=>clearInterval(E)),E},window.setTimeout=(...g)=>{const E=m(...g);return u.push(()=>clearTimeout(E)),E};try{o.scripts.forEach(g=>{Function(g)()})}finally{window.setInterval=f,window.setTimeout=m}return()=>u.forEach(g=>g())},[r.title,o.scripts]),W.jsxs("main",{className:"animation-page",children:[o.styles.map((u,f)=>W.jsx("style",{children:u},f)),W.jsxs("header",{className:"animation-header",children:[W.jsx("h1",{children:o.title}),o.intro&&W.jsx("p",{className:"animation-intro",dangerouslySetInnerHTML:{__html:o.intro}})]}),W.jsx("div",{ref:d,className:"animation-content",dangerouslySetInnerHTML:{__html:o.markup}})]})}function b2(){return W.jsx(gh,{children:W.jsxs(Wl,{element:W.jsx(s2,{}),children:[W.jsx(Wl,{index:!0,element:W.jsx(v2,{})}),$u.map(r=>W.jsx(Wl,{path:r.slug,element:W.jsx(g2,{animation:r})},r.slug)),W.jsx(Wl,{path:"*",element:W.jsx(yh,{replace:!0,to:"/"})})]})})}ym.createRoot(document.getElementById("root")).render(W.jsx(Gh,{children:W.jsx(b2,{})}));
